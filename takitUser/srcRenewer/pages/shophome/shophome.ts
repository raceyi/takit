...
//   }
  ...
  loadShopInfo()
  {
        ...
        var thisShop:any={takitId:this.takitId ,s3key: this.shop.shopInfo.imagePath, discountRate:this.shop.shopInfo.discountRate,visitedTime:new Date()};
...
/*
  ...
  menuSelected(menuName){
    ...
    this.navController.push(OrderPage,{menu:JSON.stringify(menu), shopname:this.shopname});
