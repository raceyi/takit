...
*/      
        if(!this.storageProvider.shopSelected){
            ...
            this.serverProvider.getShopInfo(takitId).then((res)=>{
                ...
                this.app.getRootNav().push(ShopHomePage,{takitId:takitId},{animate:true,animation: 'md-transition', direction: 'forward', duration:500  });
  ...
  enterOldOrder(takitId){
      ...
      this.navController.push(OldOrderPage,{"takitId":takitId});
  }
